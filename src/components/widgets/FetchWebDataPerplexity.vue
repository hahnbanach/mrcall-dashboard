  ...
  <div class="fetch-web-data">
    <div class="fetch-controls">
      <Button
        ...
        :loading="showSpinner"
        :label="showSpinner ? 'Loading...' : 'Fetch Web Content (Perplexity)'"
...
export default {
  ...
  methods: {
    fetchWebContent() {
      ...
      console.log("FetchWebDataPerplexity request:", request);
      this.showSpinner = true;

      axios.post(
        process.env.VUE_APP_STARCHAT_URL + "/mrcall/v1/mrcall0/atom/fetch_web_content_perplexity",
        request,
        { headers: headers }
      ).then((response) => {
        console.debug("FetchWebDataPerplexity Response:", response);
        ...
        this.showSpinner = false;
        console.error("FetchWebDataPerplexity Error:", error);
